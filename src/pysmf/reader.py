...
from .errors import HeaderCatalogError, SMFParseError, TruncatedSMFRecordError
...
def _read_smf_records(
    stream: BinaryIO, *, header_catalog: HeaderCatalog
) -> Iterator[SMFRecord]:
